...
function Home() {
  return (
    <div className="font-sans text-[#706D54] bg-[#DBDBDB]">
      ...
      <header className="relative">
        <div
          ...
          style={{
            ...
            backgroundColor: "#706D54", // Fallback dark tone
          }}
        >
          {/* Overlay */}
          <div className="absolute inset-0 bg-[#706D54] opacity-60"></div>
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-4">
            <div className="max-w-3xl">
              ...
              <button className="bg-[#A08963] text-white px-8 py-3 rounded-md text-lg font-medium hover:bg-opacity-90 transition mr-4">
                Explore Our Services
              </button>
              <button className="bg-transparent border-2 border-[#A08963] text-[#A08963] px-8 py-3 rounded-md text-lg font-medium hover:bg-[#A08963] hover:text-white transition">
                Contact Us
              </button>
            </div>
          </div>
      ...
      <section className="py-24 px-8 bg-[#DBDBDB]">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-16">
            <div className="md:w-1/2 mb-12 md:mb-0 pr-0 md:pr-12">
              <h2 className="text-3xl font-bold mb-6 text-[#C9B194]">
                Welcome to Our Company
              </h2>
              <p className="text-lg mb-8 leading-relaxed text-[#706D54]">
              ...
              <button className="bg-[#A08963] text-white px-6 py-3 rounded-md hover:bg-opacity-90 transition inline-flex items-center">
                Learn More About Us
                <svg
            ...
            <div className="md:w-1/2 grid grid-cols-2 gap-4">
              <div className="bg-[#DBDBDB] p-6 rounded-lg border-l-4 border-[#A08963] shadow-md">
                <div className="text-[#A08963] mb-4">
                  <svg
                    className="w-10 h-10"
                    fill="none"
                    stroke="currentColor"
                ...
                <p className="text-[#706D54]">Experience in the industry</p>
              </div>
              <div className="bg-[#DBDBDB] p-6 rounded-lg border-l-4 border-[#C9B194] shadow-md">
                <div className="text-[#C9B194] mb-4">
                  <svg
                    className="w-10 h-10"
                    fill="none"
                    stroke="currentColor"
                ...
                <p className="text-[#706D54]">Across the country</p>
              </div>
              <div className="bg-[#DBDBDB] p-6 rounded-lg border-l-4 border-[#706D54] shadow-md">
                <div className="text-[#706D54] mb-4">
                  <svg
                    className="w-10 h-10"
                    fill="none"
                    stroke="currentColor"
                ...
                <p className="text-[#706D54]">Professional team</p>
              </div>
              <div className="bg-[#DBDBDB] p-6 rounded-lg border-l-4 border-[#A08963] shadow-md">
                <div className="text-[#A08963] mb-4">
                  <svg
                ...
                <p className="text-[#706D54]">Successfully completed</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-[#DBDBDB] relative">
        <div className="absolute top-0 right-0 w-1/3 h-64 bg-[#A08963] opacity-10 rounded-bl-full"></div>
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-[#C9B194]">
              Our Services
            </h2>
            <p className="text-lg text-[#706D54] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-lg transition transform hover:-translate-y-1 hover:shadow-xl">
              <div className="h-48 bg-[#706D54] relative">
                <div className="absolute bottom-0 left-0 bg-[#A08963] text-white font-bold py-2 px-4">
                  Design
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-[#706D54]">
                  Premium Design
                </h3>
                <p className="mb-4 text-[#706D54]">
                ...
                <a
                  href="#"
                  className="text-[#A08963] font-medium flex items-center"
                >
                  Learn more
                  <svg
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg transition transform hover:-translate-y-1 hover:shadow-xl">
              <div className="h-48 bg-[#706D54] relative">
                <div className="absolute bottom-0 left-0 bg-[#C9B194] text-white font-bold py-2 px-4">
                  Materials
                </div>
              </div>
              <div className="p-6">
                ...
                <a
                  href="#"
                  className="text-[#C9B194] font-medium flex items-center"
                >
                  Learn more
                  <svg
                    className="w-4 h-4 ml-2"
      ...
      {/* Project showcase */}
      <section className="py-24 px-8 bg-[#706D54] text-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-[#DBDBDB] h-64 rounded-lg overflow-hidden"></div>
            <div className="bg-[#DBDBDB] h-64 rounded-lg overflow-hidden"></div>
            <div className="bg-[#DBDBDB] h-64 rounded-lg overflow-hidden"></div>
            <div className="bg-[#DBDBDB] h-64 rounded-lg overflow-hidden"></div>
          </div>
          <div className="text-center mt-12">
            <button className="bg-[#A08963] text-white px-8 py-3 rounded-md text-lg font-medium hover:bg-opacity-90 transition">
              View All Projects
            </button>
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-[#DBDBDB]">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#DBDBDB] p-8 rounded-lg shadow-md">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-[#706D54] rounded-full mr-4"></div>
                <div>
                  <p className="font-bold text-[#706D54]">Sarah Johnson</p>
                  <p className="text-[#706D54]">Residential Client</p>
                </div>
                <div className="ml-auto text-[#A08963]">
                  <svg
              ...
              <blockquote className="text-lg mb-4 text-[#706D54]">
              ...
              <p className="text-[#A08963] font-medium">
            ...
            <div className="bg-[#DBDBDB] p-8 rounded-lg shadow-md">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-[#706D54] rounded-full mr-4"></div>
                <div>
                  <p className="font-bold text-[#706D54]">Mark Williams</p>
                  <p className="text-[#706D54]">Commercial Client</p>
                </div>
                <div className="ml-auto text-[#A08963]">
                  <svg
                    className="w-5 h-5 inline-block"
      ...
      {/* Footer */}
      <footer className="bg-[#706D54] text-white py-12">
        <div className="container mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-400 hover:text-[#A08963]">
                Home
              </a>
              <a href="#" className="text-gray-400 hover:text-[#A08963]">
                About
